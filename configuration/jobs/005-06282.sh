...
python3 $SOFTWARE/tcrm/$BRANCH/tcevent.py -c $CONFIGFILE > $OUTPUT/$SIMULATION.stdout.$DATE 2>&1
python3 /g/data/w85/software/track2shp.py -id $SIMULATION
