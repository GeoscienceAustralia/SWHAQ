...
#     `qsub -v DATAPATH=/g/data/w85/QFES_SWHA/hazard/output/GROUP1_RCP45_1981-2010 run_lgaAnalysis.sh`
# 
# Contact:
...
python3 $HOME/tcrm/Evaluate/locationLandfallIntensity.py -p $DATAPATH > $DATAPATH/log/landfall.stdout 2>&1
