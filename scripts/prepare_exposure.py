...
def buildingClass(df, classes, thresholds, AS1170='C'):
    ...
    """
    df.loc[df['WIND_REGION_CLASSIFICATION'] == AS1170, 'AS4055_CLASS'] = \
        pd.cut(df[df['WIND_REGION_CLASSIFICATION']==AS1170]['M4'],
               bins=thresholds,
               right=True,
               labels=classes)
    return df
...
outputfile ="SEQ_Residential_Wind_Exposure_2021_TCRM_2022_VulnCurves_AS4055_M4_updated_v2.csv"
