...
def qdm(vobs, vref, vfut, dist=stats.lognorm):
    ...
    Fsf = dist.cdf(vfut, *pfut) # CDF of future, at the value of the future data points
    invFsr = dist.ppf(Fsf, *pref) #Inverse cdf of reference period distribution, evaluated at future CDF values
    
    delta = vfut / invFsr # Relative change in values
...
# Add the future data to ensemble sets:    
...
# Now we apply the QDM algorithm to the future data to determine the 
# bias corrections for each individual model. 
