...
for i, (g, r) in enumerate(product(groups, rcps)):
    for j, p in enumerate(periods):
        ...
        ax[i].set_xlabel("Maximum wind speed [m/s]")
        ax[i].set_xlim((0, 100))
        ax[i].set_title(f"{g} - {rlabel[r]}")
ax[i].legend()
plt.savefig(pjoin(datapath, "intensity_distribution.png"), bbox_inches='tight', dpi=600)
plt.close(fig)
...
for i, (g, r) in enumerate(product(groups, rcps)):
    for j, p in enumerate(periods):
        ...
        ax[i].set_title(f"{g} - {rlabel[r]}")
ax[i].legend()
plt.savefig(pjoin(datapath, "intensity_cdf.png"), bbox_inches='tight', dpi=600)
plt.close(fig)
...
for i, (g, r) in enumerate(product(groups, rcps)):
    for j, p in enumerate(periods):
        ...
        ax[i].set_title(f"{g} - {rlabel[r]}")
ax[i].legend()
plt.savefig(pjoin(datapath, "intensity_sf.png"), bbox_inches='tight', dpi=600)
plt.close(fig)
...
for i, (g, r) in enumerate(product(groups, rcps)):
    for j, p in enumerate(periods):
        ...
        ax[i].set_title(f"{g} - {rlabel[r]}")
ax[i].legend()
plt.savefig(pjoin(datapath, "latitude_lmi.png"), bbox_inches='tight', dpi=600)
plt.close(fig)
...
plt.savefig(pjoin(datapath, "intensity_quantiles.png"), bbox_inches='tight', dpi=600)